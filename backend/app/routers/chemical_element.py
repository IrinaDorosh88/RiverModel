...
def update_chemical_element(chemical_element_id:int, db: Session = Depends(get_db)):
    db_chemical_element = chemical_element_service.update_chemical_element(db, chemical_element_id)
    return db_chemical_element