...
class PredictionPoint(Base):
    ...
    measurement_id = Column('measurement_id', Integer, nullable=False) # TODO: add ForeignKey
...
# TODO:    measurement = relationship('Measurement', back_populates='prediction_point')
